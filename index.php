                  ...
                  <div class="col-lg-12">
                      <div class="row">
                          ...
                          <div class="col-lg-5 col-md-3 col-sm-12 p-0">
                              <select class="form-control search-slt src">
                                  <option>Choose Pricing</option>
  <!--                               4 stars and up -->
                                  <option>
                                    <a><p>3000-7000</p></a href="#">
                                  </option>
  <!--                               3 stars and up -->
                                  <option>
                                      <a><p>8000-12000</p></a href="#">
                                  </option>
    <!--                               2 stars and up -->
                                  <option>
                                      <a><p>13000-17000</p></a href="#">
                                  </option>
    <!--                               1 star and up -->
                                  <option>
                                      <a><p>18000-22000</p></a href="#">
                                  </option>
                                  <option>
                                      <a><p>23000-27000</p></a href="#">
                                  </option>
                                  <option>
                                      <a><p>28000-32000</p></a href="#">
                                  </option>
                              </select>
                          </div>
