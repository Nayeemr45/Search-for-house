...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCgEFd1S4iVxaQwAFrRJg5gmtYd3RW2wRc&callback=initMap"></script>
  ...
  <tbody>
        ...
        <td>
          <a href="confirm_property.php?id=<?php echo $show['id'] ?> && p_details_id=<?php echo $show['p_details_id'] ?> && owner_id=<?php echo $owner_id ?>">Confirm</a></td>
          <td>
          <a href="not_confirm_property.php?id=<?php echo $show['id'] ?> && p_details_id=<?php echo $show['p_details_id'] ?> && owner_id=<?php echo $owner_id ?>">Reject</a></td>
	</tr>
    <?php endforeach; ?>
